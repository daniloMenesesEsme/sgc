                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append" id="div-busca-cnpj" style="{{ old('tipo') == 'PJ' ? '' : 'display: none;' }}">
